...
void main()																	\n\
{																			\n\
    finalColor = vec3(0.3f, 0.7f, 0.8f);									\n\
}";
...
void myData()
{
	GLfloat vertices[] = {//lista de vertices,regla de union
		0.0f, 0.0f, 0.0f,
		0.5f, 0.0f, 0.0f,
		0.6f, 0.4f, 0.0f,
		-0.7f, 0.6f, 0.0f,
...
void display(void)
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, VBO);
	glPointSize(8.0);
	glDrawArrays(GL_POLYGON, 0, 6);//LINE_STRIP ,LINE_LOOP,TRIANGLES,TRIANGLE_STRIP,TRIANGLE_FAN(ABANICO),QUADS(CUALIRATEROS),POLYGON
...
int main()
{
	...
	*/
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // Backgound color rojo verde y azul y alfa es de 0 y 1
