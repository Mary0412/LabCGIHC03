...
/* ----------------   Práctica 2 --------------------------*/
/*-----------------    2019-2   ---------------------------*/
/*------------- Dávila Tinajero Marisela Chantal ---------------*/
#include <glew.h>
#include <glfw3.h>
...
void main()																	\n\
{																			\n\
    finalColor = vec3(0.7f, 0.5f, 0.7f);									\n\
}";
...
void myData()
{
	...
	{
		// positions         // color
		0.1f,  0.7f, 0.0f,		0.1f,  0.7f, 0.5f,  // top right
		0.1f, 0.5f, 0.0f,		1.0f,  0.5f, 0.0f, // bottom right
		-0.4f, 0.7f, 0.0f,		0.1f,  1.f, 0.0f,// bottom left
		-0.3f,  0.5f, 0.0f,		0.1f,  0.7f, 1.0f, // top left
		- 0.3f,  -0.5f, 0.0f,	0.1f,  0.7f, 0.5f,  // middle left
		-0.4f, -0.7f, 0.0f,		0.1f,  0.1f, 0.2f,//agregado en clase
		0.1f, -0.7f,0.0f,		0.1f,  0.0f, 0.0f,
		0.1f, -0.5f,0.0f,		0.8f,  0.0f, 0.8f
	};
